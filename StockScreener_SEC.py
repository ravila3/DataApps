...
def display_stock_analysis_form(stock_growth_analysis_df):
    ...
    st.data_editor(styled, key="my_editor", on_change=on_change_handle, width='stretch', disabled=disabled_cols
                ...
                'div_yield':st.column_config.NumberColumn(label="Div Yield", format='%.1f', width="small"),
                ...
                "Last3Q_Revenue_Growth_PCT": st.column_config.NumberColumn(label="Rev Growth % - Last 3Q",help="Rev Growth % - Last 3Q", format='%,.1f', width="small"),
                "Last3Q_Income_Growth_PCT": st.column_config.NumberColumn(label="Inc Growth % - Last 3Q",help="Inc Growth % - Last 3Q", format='%,.1f', width="small"),
