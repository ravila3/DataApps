...
def display_stock_analysis_form(stock_growth_analysis_df):
    ...
    st.data_editor(styled, key="my_editor", on_change=on_change_handle, width='stretch', disabled=disabled_cols
                ...
                "Last3Q_Revenue_Growth_PCT": st.column_config.NumberColumn(label="Rev Growth % - Last 3Q", format='%,.1f', width="small"),
                "Last3Q_Income_Growth_PCT": st.column_config.NumberColumn(label="Inc Growth % - Last 3Q", format='%,.1f', width="small"),
                "Last3Q_Median_Margin_PCT": st.column_config.NumberColumn(label="Median Margin % - Last 3Q", format='%,.1f', width="small"),
                "Last3Q_Margin_Growth_PCT": st.column_config.NumberColumn(label="Margin Growth % - Last 3Q", format='%,.1f', width="small"),
